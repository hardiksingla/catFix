"""
Django settings for inspection_app project.
...
SECRET_KEY = 'django-insecure-vebr@h@+#4v!j26&tpu)&7a)a%59vg*!))^06i)8(n$+su%ld*'
...
ROOT_URLCONF = 'inspection_app.urls'
...
WSGI_APPLICATION = 'inspection_app.wsgi.application'
